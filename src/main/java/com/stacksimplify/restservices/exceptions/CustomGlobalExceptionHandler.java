...
public class CustomGlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	// HttpRequestmethodNotSupoortedException
	@Override
	protected ResponseEntity<Object> handleHttpRequestMethodNotSupported(HttpRequestMethodNotSupportedException ex,
			HttpHeaders headers, HttpStatus status, WebRequest request) {

		CustomErrorDetails customErrorDetails = new CustomErrorDetails(new Date(),
				"From HttpRequestmethodNotSupoortedException Exception in GEH - Method Not allowed", ex.getMessage());
	...
	public final ResponseEntity<Object> handlerContraintViolationException(ConstraintViolationException ex,
			WebRequest request) {
		CustomErrorDetails customErrorDetails = new CustomErrorDetails(new Date(),
				ex.getMessage(), request.getDescription(false));
		return new ResponseEntity<Object>(customErrorDetails, HttpStatus.BAD_REQUEST);
